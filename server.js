...
const io = require('socket.io')(http, {
  cors: {
    origin: 'http://localhost:3000', // Adjust the origin as per your client's URL
    methods: ['GET', 'POST']
  }
});
...
const connectDB = async () => {
  try {
    await mongoose.connect('mongodb+srv://Venkatesh:Venkatesh@cluster0.qyag75y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
